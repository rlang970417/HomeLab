...
export LD_LIBRARY_PATH=${GCC_HOME}/lib64:${GCC_HOME}/lib:/lib64:/usr/lib64:/lib:/usr/lib
export PATH=${GCC_HOME}/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
