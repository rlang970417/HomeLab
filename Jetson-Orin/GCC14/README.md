# Build GCC 14 on the Jetson Orin Nano

## Introduction

A series of shell scripts to build GCC 14 on the Jetson Orin Nano. These scripts rely upon GCC 12 already being built and deployed.
